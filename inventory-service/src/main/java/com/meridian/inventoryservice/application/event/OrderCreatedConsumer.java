...
import com.meridian.inventoryservice.application.dto.OrderCreatedEvent;
...
public class OrderCreatedConsumer {
    ...
    public void handleOrderCreated(OrderCreatedEvent event) {
        ...
        Map<String, Integer> itemsToReserve = event.getItems().stream()
                .collect(Collectors.toMap(OrderItemDto::getSku, OrderItemDto::getQuantity));
        ...
        try {
            ...
            // TODO: In a full saga, we would publish an InventoryFailedEvent here to trigger compensation
