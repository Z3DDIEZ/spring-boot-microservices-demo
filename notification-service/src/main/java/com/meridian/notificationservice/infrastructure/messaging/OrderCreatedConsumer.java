...
public class OrderCreatedConsumer {
    ...
    public void handleOrderCreated(OrderCreatedEvent event) {
        ...
        // Mock email logic for now: retrieving actual user email usually requires hitting auth-service, 
        // storing email on order, OR embedding it in the domain event payload.
        // For simplicity in this demo without blocking cross-service calls, we'll dummy an email if missing 
